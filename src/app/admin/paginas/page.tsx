...
const PAGES = [
  {
    ...
    fields: [
      { key: 'hero.title', label: 'Hero — Título Principal', type: 'text' as const },
      { key: 'hero.subtitle', label: 'Hero — Subtítulo', type: 'textarea' as const },
      { key: 'hero.backgroundImage', label: 'Hero — Imagem de Fundo (Poster)', type: 'image' as const },
      { key: 'hero.backgroundVideo', label: 'Hero — URL do Vídeo (.mp4)', type: 'text' as const },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'email', label: 'E-mail de Contato', type: 'text' as const },
      { key: 'phone', label: 'WhatsApp / Telefone', type: 'text' as const },
      { key: 'address', label: 'Endereço Físico', type: 'textarea' as const },
      { key: 'hours', label: 'Horário de Atendimento', type: 'text' as const },
      { key: 'instagramUrl', label: 'Link do Instagram', type: 'url' as const },
      { key: 'whatsappUrl', label: 'Link Direto do WhatsApp', type: 'url' as const },
      { key: 'mapUrl', label: 'URL do Google Maps (Opcional)', type: 'url' as const },
    ],
  },
  {
    id: 'cafe-especial',
    label: 'Cafés Especiais',
    filePath: 'content/services/cafe-especial.json',
    pageTitle: 'Serviço: Cafés Especiais',
    fields: [
      { key: 'title', label: 'Título', type: 'text' as const },
      { key: 'shortDescription', label: 'Descrição Curta', type: 'textarea' as const },
      { key: 'image', label: 'Foto do Produto / Serviço', type: 'image' as const },
      { key: 'price', label: 'Preço', type: 'text' as const },
      { key: 'priceUnit', label: 'Unidade de Preço', type: 'text' as const },
  ...
  },
  {
    ...
    label: 'Assinatura',
    filePath: 'content/services/assinatura-mensal.json',
    pageTitle: 'Serviço: Assinatura Mensal',
    fields: [
      { key: 'title', label: 'Título', type: 'text' as const },
      { key: 'shortDescription', label: 'Descrição Curta', type: 'textarea' as const },
      { key: 'image', label: 'Foto da Caixa de Assinatura', type: 'image' as const },
      { key: 'price', label: 'Preço', type: 'text' as const },
      { key: 'priceUnit', label: 'Unidade de Preço', type: 'text' as const },
      { key: 'fullDescription', label: 'Descrição Completa', type: 'textarea' as const },
    ],
  },
  {
    id: 'corporativo',
    label: 'Corporativo',
    filePath: 'content/services/corporativo.json',
    pageTitle: 'Serviço: Café Corporativo',
    fields: [
      { key: 'title', label: 'Título', type: 'text' as const },
      { key: 'shortDescription', label: 'Descrição Curta', type: 'textarea' as const },
      { key: 'image', label: 'Foto Corporativa / Setup', type: 'image' as const },
      { key: 'price', label: 'Preço', type: 'text' as const },
      { key: 'priceUnit', label: 'Unidade de Preço', type: 'text' as const },
      { key: 'fullDescription', label: 'Descrição Completa', type: 'textarea' as const },
    ],
